  ...
  return (
    <section className="container mx-auto px-4 pt-24 pb-48">
      ...
      >
        ...
        >
          A browser extension to <span className="bg-emerald-500/20 px-1">save specific messages</span>, <span className="bg-emerald-500/20 px-1">highlight key moments</span>, and <span className="bg-emerald-500/20 px-1">organise ideas</span>- in your endless chatGPT conversation
        </motion.p>
